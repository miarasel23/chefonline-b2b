         ...
         <div class="comment-drop-box" style="padding: 0px 0px;">
           ...
           <div class="contact-form-box">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <img src="../assets/images/associate-partners/cococola.png" style="display: block; margin: auto;">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div>
                            <img src="https://www.artauk.com/web-assets/cocacola-banner.jpg" style="display: block; margin: auto;">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div>
                            <p class="">Coca-Cola Europacific Partners (CCEP), a proud sponsor of ARTA is offering a case of Schweppes simply by registry. Sign up Today!</p>
...
if ($_POST['name'] != "" && $_POST['email'] != "" && $_POST['telephone'] != "" && $_POST['enquiry'] != "") {
    if (!filter_var($_POST["email"], FILTER_VALIDATE_EMAIL)) {
        ...
        $headers .= 'From: Chefonline associate partners cocacola<2024@artauk.com>' . "\r\n" . "CC: mohibbullah.chefonline@gmail.com, 2024@artauk.com";
