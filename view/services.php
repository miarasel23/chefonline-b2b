...
<div class="section">
   ...
   <div class="aboutus-section about-area">
        <div class="container">
            <div class="row bottom-padding">
                <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">ChefOnline Products & Services</li>
                        </ul>
            ...
            <div class="row bottom-padding">
                <div class="col-md-12">
                    <h2 class="text-center">Products and Services Designed for Restaurant Businesses</h2>

                    <p class="text-justify">
                        ChefOnline is a ground-breaking, online food-ordering platform that empowers restaurants to efficiently manage online business, and enables customers to enjoy food from the best British restaurants and takeaways.
                    </p>

                    <p class="text-justify">
                        We host a variety of restaurant businesses from across the United Kingdom, providing the highest quality services, leading to the digitisation and automatisation of restaurant businesses. This allows you to reach brand new customers through extensive social media advertisement. Furthermore, ChefOnline can help you handle all administrative steps by deploying a robust and secure software solution, from the initial transaction to the final delivery.
                    </p>

                    <p class="text-justify">Our core benefits to clients include:</p>

                    <ul class="all-services-list">
                        <li><a href="online-ordering-system">A national food-ordering portal</a></li>
                        <li><a href="cloud-epos-system">EPoS system</a></li>
                        <li><a href="digital-marketing">Digital marketing</a></li>
                        <li><a href="print-media">Print media</a></li>
                    </ul>

                    <p class="text-justify">
                        Our services include customized websites, and mobile app and custom software development, all developed to meet your selected requirements. ChefOnline is dedicated to changing the very landscape of the restaurant industry in the UK, from outdated customs right into the digital revolution.
                    </p>
                </div>
            </div>
        </div>
...
<div class="showcase visible-xs">
    <section id="video-bg">
        ...
        <div class="container">
            <div class="row" id="video-main">
                <div class="col-md-12 text-center top50 bottom50">
                    <h2 class="mobile-bottom">ChefOnline | Services</h2>
                </div>
