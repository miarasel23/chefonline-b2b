		...
		$message = '
			...
			<tr>
				<td bgcolor="#0F0F0F" style="text-align:left;">
						<p style="color:#fff;padding:20px;text-align:left;font-size:18px;font-family:Arial,Helvetica,sans-serif">Thank you for choosing '.$package.'! We will contact you soon!</p>
					</td>
			</tr>
			<tr>
				...
				<tr>
					<td colspan="2"  style="text-align:left;">
						<span style="font-family:Arial,Helvetica,sans-serif;font-size:16px;font-weight:bold">Package interested in:</span>
					</td>
					<td  style="text-align:left;">
						<span style="font-family:Arial,Helvetica,sans-serif;font-size:16px">'. $package.'</span>
					</td>
				</tr>';
