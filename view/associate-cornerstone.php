         ...
         <div class="comment-drop-box" style="padding: 0px 0px;">
           ...
           <div class="contact-form-box">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <img src="https://www.artauk.com/web-assets/cornerstone.png" style="display: block; margin: auto;">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div>
                            <img src="https://www.artauk.com/web-assets/cornerstone-banner.jpg" style="display: block; margin: auto;">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div>
                            <p>As a token of your support and ARTA 2023 sponsorship, we offer an exclusive deal on your next insurance renewal, valid for 12 months, even if you've just renewed. To <a href="https://www.ccinsure.co.uk/arta-2023-sponsorship/" target="_blank">read more...</a></p>
                            <br>
                            <p>Sign up today</p>
                            <span style="color: red;">**T&C Apply</span>
                        </div>
                    </div>
                </div>
...
if ($_POST['name'] != "" && $_POST['email'] != "" && $_POST['telephone'] != "" && $_POST['enquiry'] != "") {
    if (!filter_var($_POST["email"], FILTER_VALIDATE_EMAIL)) {
        ...
        $headers .= 'From: Chefonline associate partners cornerstone<2024@artauk.com>' . "\r\n" . "CC: mohibbullah.chefonline@gmail.com, 2024@artauk.com";
