      ...
      <div class="section">
         <div class="comment-drop-box" style="padding: 0px 0px;">
            <!-- <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <img src="../assets/images/associate-partners/wpc.png" style="width: 100%;" >
                    </div>
                </div>
 ...
 -->
           ...
           <div class="contact-form-box">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <img src="../assets/images/associate-partners/wpc.png" style="display: block; margin: auto;">
                    </div>
                </div>
...
if ($_POST['name'] != "" && $_POST['email'] != "" && $_POST['telephone'] != "" && $_POST['enquiry'] != "") {
    if (!filter_var($_POST["email"], FILTER_VALIDATE_EMAIL)) {
        ...
        $headers .= 'From: Chefonline associate partners paytap<2024@artauk.com>' . "\r\n" . "CC: mohibbullah.chefonline@gmail.com, 2024@artauk.com";
