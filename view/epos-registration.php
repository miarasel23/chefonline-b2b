...
<?php require 'eposFormValidation.php'; ?>
         ...
         <div class="row">
               <div class="col-md-12">
                     <ul class="breadcrumb">
                        ...
                        <li class="active">EPoS Sign Up</li>
                     </ul>
               ...
               <div id="mainform">
                  <div id="form">
                     <!-- <h3 class="head-text">Business Registration Form</h3> -->
                        <form id="contact_form" action="epos-registration" method="post" onsubmit="return FormValidation();">
                     <ul>
                            <li class="form-element col-md-6">
                              <input id="OwnerName" class="input" name="OwnerName" type="text" placeholder="Name" pattern="^([A-Za-z]+[,.]?[ ]?|[A-Za-z]+['-]?)+$" maxlength="50" value='<?php echo $val = (isset($OwnerName)) ? $OwnerName : null; ?>' onkeypress='return validChar(event);' required>
                         ...
                         <li class="form-element col-md-6">
                             <input id="RestaurantName" class="input" name="RestaurantName" type="text" placeholder="Business Name"  value='<?php echo $val = (isset($RestaurantName)) ? $RestaurantName : null; ?>' maxlength="100" required>
                         ...
                         <li class="form-element col-md-6">
                             <input id="BusinessPhone" class="input" name="BusinessPhone" type="text" placeholder="Mobile Number" value='<?php echo $val = (isset($BusinessPhone)) ? $BusinessPhone : null; ?>' pattern="^(((\+44\s?\d{4}|\(?0\d{4}\)?)\s?\d{3}\s?\d{3})|((\+44\s?\d{3}|\(?0\d{3}\)?)\s?\d{3}\s?\d{4})|((\+44\s?\d{2}|\(?0\d{2}\)?)\s?\d{4}\s?\d{4}))(\s?\#(\d{4}|\d{3}))?$" maxlength="15" onkeypress='return validateQty(event);' required>
                         ...
                         <li class="form-element col-md-6">
                             <input id="RestaurantPhone" class="input" name="RestaurantPhone" type="text" placeholder="Business Phone Number" value='<?php echo $val = (isset($RestaurantPhone)) ? $RestaurantPhone : null; ?>' pattern="^(((\+44\s?\d{4}|\(?0\d{4}\)?)\s?\d{3}\s?\d{3})|((\+44\s?\d{3}|\(?0\d{3}\)?)\s?\d{3}\s?\d{4})|((\+44\s?\d{2}|\(?0\d{2}\)?)\s?\d{4}\s?\d{4}))(\s?\#(\d{4}|\d{3}))?$" maxlength="15" onkeypress='return validateQty(event);' required>
                           ...
                           <li class="form-element col-md-6">
                              <input id="BusinessEmail"class="input" name="BusinessEmail" type="text" placeholder="example@email.com"  value='<?php echo $val = (isset($BusinessEmail)) ? $BusinessEmail : null; ?>' pattern="^([a-z0-9_\.-]+)@([\da-z\.-]+){3,6}\.([a-z\.]{2,6})$" maxlength="50" required>
                           ...
                           <li class="form-element col-md-6">
                              <input id="BusinessAddress1" class="input" name="BusinessAddress1" type="text" placeholder="Business Address" maxlength="200" value='<?php echo $val = (isset($BusinessAddress1)) ? $BusinessAddress1 : null; ?>' required>
                         ...
                         <li class="form-element col-md-6">
                             <select id="business_type" name="business_type" class="selectpicker" required>
                                     <option value="">Select Business Type</option>
                                     <option value="Restaurant">Restaurant</option>
                                     <option value="Takeaway">Takeaway</option>
                             </select>
                             <div class="warning-message" id="business_typeErr"><?php echo $msg = (isset($error_business_type)) ? $error_business_type : null;?></div>
                         </li>


                           <li class="form-element col-md-6">
                              <input id="BusinessPostcode" class="input" name="BusinessPostcode" type="text" placeholder="Postcode"  maxlength="11" value='<?php echo $val = (isset($BusinessPostcode)) ? $BusinessPostcode : null; ?>' pattern="^[A-Za-z]{1,2}[0-9R][0-9A-Za-z]?[\s]?[0-9][ABD-HJLNP-UW-Z abd-hjlnp-uw-z]{2}$">
                         ...
                         <li class="form-element col-md-4">
                             <select id="epos_product" name="epos_product[]" class="selectpicker" multiple data-live-search="true" required>
                                 <optgroup label="Enterprise EPoS Packages">
                                     <option value="Enterprise EPoS Packages - ChefOnline Enterprise EPoS">ChefOnline Enterprise EPoS </option>
                                     <option value="Enterprise EPoS Packages - Pro Enterprise EPoS - Yuno">Pro Enterprise EPoS - Yuno</option>
                                     <option value="Enterprise EPoS Packages - Pro Enterprise EPoS - Sango">Pro Enterprise EPoS - Sango</option>
                                 </optgroup>
                                 ...
                                 <optgroup label="Add ons">
                                     ...
                                     <option value="Add ons - Thermal Receipt Printer">Thermal Receipt Printer</option>
                                     ...
                                     <option value="Add ons - Post Code Database License">Post Code Database License</option>
                                 </optgroup>
                             </select>
                             <div class="warning-message" id="epos_productErr"><?php echo $msg = (isset($error_epos_product)) ? $error_epos_product : null;?></div>
                         </li>
                         ...
                         <li class="form-element col-md-4">
                             <select name="how_did_you_know" id="how_did_you_know" class="input how_did_you_know" onchange="others_how_did_you_know(this.value);">
                                 <option value="" disabled selected hidden>How did you know about ChefOnline EPoS?</option>
...
<script type="text/javascript">
    $('#epos_product').selectpicker({noneSelectedText: 'Select Package'});
</script>