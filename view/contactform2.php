...
else
{
		...
		$headers .= 'From:tanvirul.islam@chefonline.co.uk <tanvirul.islam@chefonline.co.uk>' . "\r\n";
		//$to       = 'business.registration@chefonline.co.uk';
        $to       = 'newsletter@chefonline.com,'.$user_email;
    ...
    <tr>
        <td>
            ...
            <table bgcolor='#444444' align='center' border='0' cellpadding='0' cellspacing='0' style='width:100%; background:#444444;'>
                <tbody>
                    <tr>
                        <td><p style='color:#fff; text-align:center; margin:10px; padding:0; font-size:10px;font-family:Verdana, Geneva, sans-serif;'>  © 2018 ChefOnline. ALL Rights Reserved.   </p></td>
                    </tr>
                </tbody>
            </table>
