...
<div id="pricing">
    <img src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/images/web-banner-2023.jpg" class="banner-image" alt="">
</div>
...
<div id="pricing">
    ...
    <div class="single-card" id="epos-section">
        <div class="wrapper popular">
            ...
            <img src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/images/epos-black-friday-offer-2022.png"
    ...
    <div class="single-card">
        <div class="wrapper popular">
            ...
            <img src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/images/join-chefOnline-black-friday-offer-2022.png"
                alt="join-chefOnline-black-friday-offer-2022.png">

            <p class="last-para-tag-content last-para-tag-content-margin para-tag-margin-top">
                <b>Offer Fee: <s>£800</s></b>
                <span class="Offer-Setup-Fee" id="last-para-tag-price">
                    <sup><b>£0</b></sup>
                </span>
            </p>
            ...
            <ul>
                <li>
                    <i class="fas fa-check"></i>
                    <span>Join ChefOnline with 2 Months of Free <br> SEO Marketing worth £800</span>
                </li>
                
                <li>
                    <i class="fas fa-check"></i>
                    <span>No Subscription Fee for 1st 4 weeks</span>
                </li>
                <li>
                    <i class="fas fa-check"></i>
    ...
    <div class="single-card">
        <div class="wrapper popular">
            ...
            <img src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/images/seo-black-friday-offer-2022.png"
            ...
            <ul>
                <li>
                    <i class="fas fa-check"></i>
                    <span>Save 50% on Monthly Charges</span>
                </li>
                <li>
                    <i class="fas fa-check"></i>
            ...
            <div class="purchase-section purchase-section1">
                <a href="#info"><input type="submit" value="Get Now" class="btn-purchase"
    ...
    <div class="single-card">
        <div class="wrapper popular">
            ...
            <img src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/images/print-media-black-friday-offer-2022.png"
            ...
            <p id="termsCondition5" class="t-and-c-apply t-and-c-apply5">
                <a href="https://www.chefonline.com/terms-conditions" target="_blank">*T&C Apply</a>
                <br>
                <span style="width: 100%;
    display: block;
    font-size: 12px;
    color: #222;">* The Full amount must be paid by 30th November</span>
            </p>
...
<div class="wrapper form-section-margin" id="info">
    <form action="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/black_friday_offer_form.php" method="post">
        <div class="form">
