...
<div id="pricing">
    <img src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/images/valentine-offers.png" class="banner-image"
        alt="">
</div>
...
<div class="wrapper form-section-margin" id="info">
	<!-- black_friday_offer_form -->
    <form action="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/valentine_offer_form.php" method="post">
        <div class="form">
			...
			<div class="purchase-section">
                ...
                <a href=""><input type="submit" name="black_friday_offer_query" value="Submit"
                        class="btn-purchase" /></a>
            </div>
        </div>
    </form>
