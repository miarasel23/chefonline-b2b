...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	elseif (strlen($BusinessPostcode)>$PostCode_length) {
	...
	//	 echo "<b>Restaurant Phone: </b>".$RestaurantPhone."<br>";
       ...
       $sql = "INSERT INTO business_registration (restaurant_id, owner_name, owner_email, owner_number, restaurant_name, restaurant_number, restaurant_address, restaurant_city, restaurant_country, restaurant_postcode)
VALUES ('0','".$OwnerName."','".$BusinessEmail."','".$BusinessPhone."','".$RestaurantName."','".$RestaurantPhone."','".$BusinessAddress1."','".$BusinessCity."','".$BusinessPostcode."', '".$Country."')";
    ...
    if ($db_con->query($sql)) {
		...
		if( $_POST['want_text_message'] == 'on' ):
  		...
  		$data = [ 'rest_id' => $res_id, 'email' => $email, 'platform' => 1, 'mobile' => $mobile,'want_newslatter' => $want_newslatter, 'want_text_message' => $want_text_message ];	

  	    $ch = curl_init();
  	    curl_setopt($ch, CURLOPT_URL, "https://www.chefonline.co.uk/ExternalAPI/business_subcription_insert");
		...
		$to 	 = "$BusinessEmail";
		$subject = "Business Registration Request";
	...
	<table width="600" border="0" cellpadding="0" cellspacing="10">
	 <tbody><tr>
		<td bgcolor="#0F0F0F" style="text-align:left;">
				<p style="color:#fff;padding:20px;text-align:left;font-size:18px;font-family:Arial,Helvetica,sans-serif">Thank you for choosing ChefOnline. Member of our team will contact you soon.</p>
			</td>
	 </tr>
	 <tr>
		...
		<table width="800" border="0">
		 <tbody><tr>
			<td colspan="3"  style="text-align:left;">
				<span style="color:#1c2256;font-family:Arial,Helvetica,sans-serif;font-size:20px;line-height:25px">BUSINESS DETAILS</span>
			</td>
		</tr>
		<tr>
			<td colspan="2"  style="text-align:left;">
				<span style="font-family:Arial,Helvetica,sans-serif;font-size:16px;font-weight:bold">Contact Name:</span>
			</td>
		...
		<tr>
			<td colspan="2"  style="text-align:left;">
				<span style="font-family:Arial,Helvetica,sans-serif;font-size:16px;font-weight:bold">Contact Email:</span>
			</td>
			<td  style="text-align:left;">
		...
		<tr>
			<td colspan="2"  style="text-align:left;">
				<span style="font-family:Arial,Helvetica,sans-serif;font-size:16px;font-weight:bold">Contact Number:</span>
			</td>
			<td  style="text-align:left;">
		...
		<tr>
		    <td colspan="2"  style="text-align:left;">
			<span style="font-family:Arial,Helvetica,sans-serif;font-size:16px;font-weight:bold">Business Phone Number:</span>
			</td>
			<td  style="text-align:left;">
		...
		<tr>
			<td colspan="2"  style="text-align:left;">
				<span style="font-family:Arial,Helvetica,sans-serif;font-size:16px;font-weight:bold">Post Code:</span>
			</td>
			<td  style="text-align:left;">
		...
		<tr>
			<td colspan="2"  style="text-align:left;">
				<span style="font-family:Arial,Helvetica,sans-serif;font-size:16px;font-weight:bold">Town/City:</span>
			</td>
			<td  style="text-align:left;">
				<span style="font-family:Arial,Helvetica,sans-serif;font-size:16px">'. $BusinessCity.'</span>
			</td>
		</tr>
		<tr>
			<td colspan="2"  style="text-align:left;">
		...
		<tr>
			<td colspan="2"  style="text-align:left;">
				<span style="font-family:Arial,Helvetica,sans-serif;font-size:16px;font-weight:bold">How did you know about ChefOnline?:</span>
			</td>
			<td  style="text-align:left;">
