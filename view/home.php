    ...
    <section id="video-bg" class="">
        ...
        <div class="container bottompad70 home-intro-div">
            <div class="row" id="video-main">
                ...
                <div class="col-lg-5ths col-md-5ths col-sm-6 col-xs-12 text-center">
                ...
                <div class="col-lg-5ths col-md-5ths col-sm-6 col-xs-12 text-center">
                    <a target="_blank" class="box-icon" href="https://www.tablebookings.co.uk/">
                        <div class="small-icon bg border border-info">
                            <!-- <span class="livicon" data-n="brush" data-c="#ec193a" data-s="62" data-hc="0"></span> -->
                            <span class="livicon" data-n="calendar" data-s="62" data-c="#ffffff" data-hc="0"></span>
                            <!-- <span class="livicon" data-n="brush" data-s="62" data-c="#ffffff" data-hc="#ffffff"></span> -->
                        </div>
                        <h6 class="title text-center">Table Booking</h6>
                        <div class="btn btn-custom"><i class="fa fa-caret-right"></i>Enter Site</div>
                    </a>
                </div>
...
<!-- offer section -->
<!-- <section id="offer-discount">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div id="offer-discount-slider" class="offer-discount-slider owl-carousel owl-theme">

                    <div class="item">
                        <a href="offers"><img src="https://www.chefonline.com/images/B2B_ChefOnline_13122021.jpg"
                                class="center-block" alt="offer & discount" width="370" height="151"></a>
                    </div>

                    <div class="item">
                        <a href="offers"><img src="https://www.chefonline.com/images/B2B_DigitalMarketing_13122021.jpg"
                                class="center-block" alt="offer & discount" width="370" height="151"></a>
                    </div>

                    <div class="item">
                        <a href="offers"><img src="https://www.chefonline.com/images/B2B_EPoS_13122021.jpg"
                                class="center-block" alt="offer & discount" width="370" height="151"></a>
                    </div>

                    <div class="item">
                        <a href="offers"><img src="https://www.chefonline.com/images/B2B_PrintMedia_13122021.jpg"
                                class="center-block" alt="offer & discount" width="370" height="151"></a>
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-7 col-md-7 col-md-push-5">
                            <p class="text-justify">Running a restaurant or takeaway has never been more challenging.
                                Rising operating costs, increasing competition, staff shortages, and higher food prices
                                continue to put pressure on hospitality businesses across the UK.
                                At the same time, customer demand for online ordering continues to grow, with more
                                people choosing the convenience of ordering food directly from their favourite local
                                restaurants and takeaways.</p>
                            <p class="text-justify">
                                Join ChefOnline and take advantage of this growing market. Our platform helps you accept
                                online orders, reach more customers, and increase direct sales through your own branded
                                ordering system.</p>
                            <p class="text-justify">
                                We'll get your restaurant up and running quickly and provide the tools you need to
                                manage orders efficiently, grow your online presence, and build customer loyalty.
                                Start selling online with ChefOnline today and take your takeaway business to the next
                                level.</p>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <img class="img-responsive  hidden-sm hidden-md hidden-lg hide-dextop"
                                            src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/hayper/paralax-bg-home-2.png"
                    ...
                    <div class="row  about-area">
                        ...
                        <div class="col-md-6 info">
                            <div class="site-heading info">
                                ...
                                <img class="img-responsive mb-15  hidden-sm hidden-md hidden-lg hide-dextop"
                                    src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/hayper/printmedia.png"
        ...
        <div class="modal-content">
            ...
            <div class="modal-inner-div">
                ...
                <div class="modal-body">
                    <img src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/assets/images/promotion.jpg"
...
<!-- <script>
if (Cookies.get('specialOffer') == null) {
    $('#promotion').modal('show');
    Cookies.set('specialOffer', 'yes', {
        expires: 30
    });
}
</script> -->
