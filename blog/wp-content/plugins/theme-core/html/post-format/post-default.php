...
elseif (has_post_format('gallery')) : if ($atts['post_layout'] == 'medium') echo '<div class="' .  esc_attr($class) . '">' ?>
    ...
    <div class="wrapper-img"><a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
        ...
        <?php if (!empty($atts['view_more'])) { ?>
            <div class="wrapper-mask">
                <div class="mask" data-link="<?php the_permalink(); ?>"><span class="readmore"><a href="<?php the_permalink(); ?>"
