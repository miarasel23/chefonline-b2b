	...
	<div class="section">
			...
			<div class="feed_setting_page">
						...
						<div class="col-md-12 no-pad form-group pb-1">
							<div class="col-md-12 no-pad pt-1">
								<div class="row">
									<div class="ffp_set_l col-md-6">
										<label class="ffp_font_bold">
											<?php esc_html_e('Choose page, Group or Profile:', WEBLIZAR_FACEBOOK_TEXT_DOMAIN); ?></label>
									</div>
									<div class="col-md-6">
										<select name="feed_type" id="feed_type" style="width:100px;"
											...
											<option value="page" selected="selected">
												<?php esc_html_e('Page', WEBLIZAR_FACEBOOK_TEXT_DOMAIN); ?>
											</option>
							...
							<div id="ffp_type_page" class="col-md-12 no-pad ffp_page_id" style="display: none;">
								<div class="row">
									<div class="ffp_set_l col-md-6">
										<label
											class="ffp_font_bold"><?php esc_html_e('Facebook Access Token:', WEBLIZAR_FACEBOOK_TEXT_DOMAIN); ?></label>
									</div>
									<div class="ffp_set_l col-md-6">
							...
							<div id="ffp_type_page" class="col-md-12 no-pad ffp_page_url" style="display:none;">
								<div class="row">
									<div class="ffp_set_l col-md-6">
										<label
											class="ffp_font_bold"><?php esc_html_e('Page ID:', WEBLIZAR_FACEBOOK_TEXT_DOMAIN); ?></label>
									</div>
									<div class="ffp_set_l col-md-6">
							...
							<div id="ffp_type_group" class="col-md-12 no-pad" style="display:none; color:red;">
								<div class="row">
									<div class="col-md-6">
										<label for="ffp_group_url" class="ffp_font_bold">
											<?php esc_html_e('Group id:', WEBLIZAR_FACEBOOK_TEXT_DOMAIN); ?>
										</label>
									</div>
							...
							<div id="ffp_type_group_token" class="col-md-12 no-pad" style="display:none; color:red;">
								<div class="row">
									<div class="col-md-6">
										<label for="ffp_group_token"
											class="ffp_font_bold"><?php esc_html_e('Acess Token:', WEBLIZAR_FACEBOOK_TEXT_DOMAIN); ?></label>
									</div>
							...
							<div class="col-md-12 no-pad pt-1 pb-1">
								<div class="row">
									<div class="col-md-6">
										<label
											class="ffp_font_bold"><?php esc_html_e('Content type:', WEBLIZAR_FACEBOOK_TEXT_DOMAIN); ?>
										</label>
									</div>
									<div class="col-md-6">
								...
								<div class="col-md-12 no-pad timeline_content" style="display:none">
									<div class="row">
										<div class="col-md-6">
											<label class="ffp_font_bold">
												<?php esc_html_e('Show posts by:', WEBLIZAR_FACEBOOK_TEXT_DOMAIN); ?>
											</label>
										</div>
										<div class="col-md-6">
											<select name="ffp_timeline_type" disabled id="ffp_timeline_type">
												<option value="posts">
													<?php esc_html_e('Owner', WEBLIZAR_FACEBOOK_TEXT_DOMAIN); ?>
												</option>
												<option value="feed">
													<?php esc_html_e('Owner and other', WEBLIZAR_FACEBOOK_TEXT_DOMAIN); ?>
												</option>
											</select>
								...
								<div class="row">
									<div class="col-md-6">
										<label class="ffp_font_bold">
											<?php esc_html_e('Hover Effect', WEBLIZAR_FACEBOOK_TEXT_DOMAIN); ?></label>
									</div>
									<div class="col-md-6">
										<select name="ffp_gallery_effect" id="ffp_gallery_effect" class="form-control"
											disabled>
											<option value="gallery_effect_1">
												<?php esc_html_e('60+ Image Effects', WEBLIZAR_FACEBOOK_TEXT_DOMAIN); ?>
											</option>
										</select>
										<!-- <p class="description"><?php esc_html_e('Available in pro version.', WEBLIZAR_FACEBOOK_TEXT_DOMAIN); ?>
										</p> -->
							...
							<div class="col-md-12 no-pad form-group pb-1">
								...
								<div class="col-md-12 no-pad">
									<div class="row">
										<div class="col-md-6">
											<label
												class="ffp_font_bold"><?php esc_html_e('Hover color', WEBLIZAR_FACEBOOK_TEXT_DOMAIN); ?></label>
										</div>
										<div class="col-md-6">
											<input type="text" class="weblizar-feed-color-picker" name="ffp_hover_color"
												...
												" />
											<p class="description">
												<?php esc_html_e('Choose feed hover color.', WEBLIZAR_FACEBOOK_TEXT_DOMAIN); ?>
											</p>
										</div>
									</div>
								</div>
								<div class="col-md-12 no-pad">
									<div class="row">
										<div class="col-md-6">
											<label class="ffp_font_bold">
												<?php esc_html_e('Number of posts:', WEBLIZAR_FACEBOOK_TEXT_DOMAIN); ?></label>
										</div>
										<div class="col-md-6">
								...
								<div class="col-md-12 no-pad">
									<div class="row">
										<div class="col-md-6">
											<label class="ffp_font_bold">
												<?php esc_html_e('Loading effect:', WEBLIZAR_FACEBOOK_TEXT_DOMAIN); ?></label>
										</div>
										<div class="col-md-6">
											<select id="ffp_loading_effect" disabled name="ffp_loading_effect">
												<option value="none">
													<?php esc_html_e('None', WEBLIZAR_FACEBOOK_TEXT_DOMAIN); ?>
												</option>
											</select>
											<!-- <p class="description"><?php esc_html_e('Available in pro version.', WEBLIZAR_FACEBOOK_TEXT_DOMAIN); ?>
											</p> -->
								...
								<div class="col-md-12 no-pad">
									<div class="row">
										<div class="col-md-6 ">
											<label
												class="ffp_font_bold"><?php esc_html_e('Show Header:', WEBLIZAR_FACEBOOK_TEXT_DOMAIN); ?></label>
										</div>
										<div class="col-md-6">
											...
											<p class="description">
												<?php esc_html_e('Do you want to show cover image.', WEBLIZAR_FACEBOOK_TEXT_DOMAIN); ?>
											</p>
										</div>
									</div>
								</div>
								<div class="col-md-12 no-pad timeline_content" style="display:none">
									<div class="row">
										<div class="col-md-6">
											<label class="ffp_font_bold">
												<?php esc_html_e('Select layout:', WEBLIZAR_FACEBOOK_TEXT_DOMAIN); ?>
											</label>
										</div>
										<?php
										...
										<div class="col-md-6">
											...
											<p class="description">
												<?php esc_html_e('Select time-line(Posts) layout.', WEBLIZAR_FACEBOOK_TEXT_DOMAIN); ?>
											</p>
										</div>
									</div>
								</div>
								<div class="col-md-12 no-pad">
									<div class="row">
										<div class="col-md-6">
											<label
												class="ffp_font_bold"><?php esc_html_e('Light Box Styles', WEBLIZAR_FACEBOOK_TEXT_DOMAIN); ?></label>
										</div>
										<div class="col-md-6">
											<select name="ffp_light_Box" id="ffp_light_Box">
												<optgroup label="Select Light Box">
													<option value="custom_box">
														<?php esc_html_e('Custom Box', WEBLIZAR_FACEBOOK_TEXT_DOMAIN); ?>
													</option>
													<option value="custom_box">
														<?php esc_html_e(' 8+Light-Box Layouts available in Pro', WEBLIZAR_FACEBOOK_TEXT_DOMAIN); ?>
													</option>
												</optgroup>
											</select>
											<p class="description">
												<?php esc_html_e('Select lightbox Styles.', WEBLIZAR_FACEBOOK_TEXT_DOMAIN); ?>.
											</p>
				...
				<div class="col-md-12 col-sm-12 col-xs-12 plugin_desc form-group">
					<div class="row">
						<div class="col-md-1">
							<label
								class="ffp_font_bold"><?php esc_html_e('Custom Css', WEBLIZAR_FACEBOOK_TEXT_DOMAIN); ?></label>
						</div>
						<div class="col-md-11">
		...
		<div class="col-md-12">
			...
			<div style="text-align:center;">
				<img id="loading-image"
					...
					alt="<?php esc_attr_e('Weblizar', WEBLIZAR_FACEBOOK_TEXT_DOMAIN); ?>" height="200"
					style="margin-top:-10px; margin-right:10px;" alt="Loading..." class="admin_loading_css" />
			</div>
		...
		<div class="col-md-12 col-sm-12 col-xs-12 form-group plugin_desc">
			...
			<p style="font-size: 15px;line-height: 1.5;">
				<?php esc_html_e('copy this shortcode', WEBLIZAR_FACEBOOK_TEXT_DOMAIN); ?>
				&nbsp; <strong><b>[facebook_feed]</b></strong>
				&nbsp;<?php esc_html_e('to any page, post or widget where you want to showcase your Facebook feed.', WEBLIZAR_FACEBOOK_TEXT_DOMAIN); ?>
			</p>
		</div>
	</div>
