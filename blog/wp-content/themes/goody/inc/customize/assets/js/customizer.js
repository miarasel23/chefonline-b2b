(function ($) {
    ...
    $(document).ready(function() {
        ...
        controlSlider.each( function() {
            var inputField = $(this).find( '.goody-slider-range-input' ),
                sliderRange = $(this).find( '.goody-slider-range' );

            $(this).find('.goody-slider-range').slider({
                range: "min",
        ...
        $( '.goody-slider-range-input' ).on( 'keyup paste', function() {
            $(this).change();
        ...
        $( '.goody-slider-range-input' ).on( 'change', function() {
