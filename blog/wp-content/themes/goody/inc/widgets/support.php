<?php
  ...
  * widgets support
  **/
  class goody_support extends WP_Widget{

      /*function construct*/
      public function __construct() {
          parent::__construct(
            'support', esc_html__('+NA: Support','goody'),
             array('description'=> esc_html__('Display Support info', 'goody'))
          );
      }
      /**
       * font-end widgets
      ...
      */
      public function form($instance){
          ...
          ?>
          <p>
              <label for=<?php echo esc_attr($this->get_field_id('icon')); ?>><?php esc_html_e('Icon:','goody') ; ?></label>
          ...
          <p>
              <label for="<?php echo esc_attr($this->get_field_id('text-support')); ?>"><?php esc_html_e( 'Text support:', 'goody' ); ?></label>
          ...
          <!-- description -->
          <p>
              <label for="<?php echo esc_attr($this->get_field_id( 'description' )); ?>"><?php esc_html_e('Description:', 'goody'); ?></label>
  ...
  function goody_support(){
      register_widget('goody_support');
  }
  add_action('widgets_init','goody_support');
?>