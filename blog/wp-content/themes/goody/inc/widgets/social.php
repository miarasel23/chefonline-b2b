<?php
if (!class_exists('goody_social')) {
    class goody_social extends WP_Widget
    {
        ...
        {
            $widget_ops = array('classname' => 'goody_social', 'description' => esc_html__('Displays your social profile.', 'goody'));

            parent::__construct(false, esc_html__('+NA: Social', 'goody'), $widget_ops);
        }
        ...
        function widget($args, $instance)
        {
            ...
            echo '<div class="goody-social-icon clearfix">';
...
add_action('widgets_init', 'goody_social_widgets');

function goody_social_widgets()
{
    register_widget('goody_social');
}
