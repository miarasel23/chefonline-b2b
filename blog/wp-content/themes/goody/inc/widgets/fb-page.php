...
class wide_fb_page extends WP_Widget{
    ...
    public function __construct() {
        parent::__construct(
            'fb_page',esc_html__('+NA: Facebook Page','goody'),
            array('description'=>esc_html__('Facebook Page', 'goody'))
        );
    }
    /**
     * font-end widgets
    ...
    public function form($instance){
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('address')); ?>"><?php echo esc_html_e('Link address your facebook:','goody'); ?></label>
