 ...
 **/
class goody_about extends WP_Widget{
	...
	public function __construct() {
		...
		$widget_ops = array('classname' => 'about', 'description' => esc_html__('Easy add About.', 'goody'));

		/* Create the widget. */
		parent::__construct('about', esc_html__('+NA: About', 'goody'), $widget_ops, $control_ops);
	}
	/**
	 * font-end widgets
	 */
...
function goody_about(){
	register_widget('goody_about');
}
add_action('widgets_init','goody_about');
?>