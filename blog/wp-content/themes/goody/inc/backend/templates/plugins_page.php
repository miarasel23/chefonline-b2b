...
<div class="nano-install-plugins">
    <div class="theme-browser rendered">
        ...
        foreach( $plugins as $plugin ):
            ...
            $plugin_action = $this->goody_theme_plugin_links( $plugin );
            ...
            <div class="theme <?php echo esc_attr($class); ?>">
                ...
                <h3 class="theme-name">
                    ...
                    <?php if( isset( $installed_plugins[$plugin['file_path']] ) ): ?>
                        <div class="plugin-info">
                            <?php echo sprintf( esc_html__('Version %s','goody'), $installed_plugins[$plugin['file_path']]['Version'] ); ?>
                        </div>
                    <?php endif; ?>
                </h3>
                ...
                if( isset( $plugin_action['update'] ) && $plugin_action['update'] ): ?>
                    <div class="theme-update nano-update">
                        <?php esc_html_e('Update Available: Version','goody'); ?> <?php echo esc_attr($plugin['version']); ?>
                    </div>
                <?php endif; ?>
                <?php
                if( $plugin['required'] ): ?>
                    <div class="plugin-required">
                        <?php echo esc_html__( 'Required', 'goody' ); ?>
                    </div>
                <?php endif; ?>
            </div>
        <?php endforeach; ?>
