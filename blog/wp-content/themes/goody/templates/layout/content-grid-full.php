...
//number word content
$number_word = get_theme_mod('goody_number_content_post','45');
$placeholder_image = get_template_directory_uri(). '/assets/images/layzyload-grid-full.jpg';
$share = get_theme_mod('goody_post_meta_share', false);
?>
<article  <?php post_class('post-item grid-full clearfix'); ?>>
    <div class="article-image">
        <?php if(has_post_thumbnail()) : ?>
            <?php $thumbnail_src = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), "goody-blog-grid-full" ); ?>
