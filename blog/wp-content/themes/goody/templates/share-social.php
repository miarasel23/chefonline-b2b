...
<div class="social share-links clearfix">
    <?php
    $share_facebook     = get_theme_mod('goody_share_facebook',true);
    $share_twitter      = get_theme_mod('goody_share_twitter',true);
    $share_google       = get_theme_mod('goody_share_google',true);
