    ...
    <main id="main" class="site-main" role="main">
        ...
        while ( have_posts() ) : the_post();
            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                    ...
                    <nav id="image-navigation" class="entry_pagination pull-right">
                        <div class="image-pagination pagination">
                            <div class="page-numbers">
                                <?php previous_image_link( false, esc_html__( 'Previous Image', 'goody' ) ); ?>
                            </div>
                            <div class="page-numbers">
                                <?php next_image_link( false, esc_html__( 'Next Image', 'goody' ) ); ?>
                            </div>
                        </div><!-- .nav-links -->
                ...
                <div class="entry-content">
                    ...
                    <div class="entry-attachment">
                        ...
                        $image_size = apply_filters( 'goody_attachment_size', 'large' );
            ...
            the_post_navigation( array(
                'prev_text' => _x( '<span class="meta-nav">Published in</span><span class="post-title">%title</span>', 'Parent post link', 'goody' ),
            ) );
